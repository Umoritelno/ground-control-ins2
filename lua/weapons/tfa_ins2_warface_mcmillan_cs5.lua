...
SWEP.Type                   = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and "Type: Bolt-Action Sniper Rifle - Caliber: 7.62x51mm - Muzzle Velocity: 420 m/s" or "Bolt-Action Sniper Rifle"
SWEP.Purpose				= "A 7.62x51MM Subsonic Integrally Suppressed Bolt Action Sniper Rifle."   
SWEP.Instructions		    = ""    
...
SWEP.Primary.Damage                = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and 150 * TFA.Yankys_Custom_Weapon_Pack.DamageMultiplier or 125
...
-- Firing Cone Related
SWEP.Primary.Spread              = .0242                      -- This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy        = .00038                     -- Ironsight accuracy, should be the same for shotguns

-- Unless you can do this manually, autodetect it.  If you decide to manually do these, uncomment this block and remove this line.
SWEP.Primary.SpreadMultiplierMax = 4.84                       -- How far the spread can expand when you shoot. Example val: 2.5
SWEP.Primary.SpreadIncrement     = 3.65                       -- What percentage of the modifier is added on, per shot.  Example val: 1/3.5
...
SWEP.Primary.RangeFalloffLUT = {
	...
	lut = {
		...
		{range = 800, damage = 1},
		{range = 800, damage = 1},
		{range = 1000, damage = 0.9},
		{range = 1200, damage = 0.85},
		{range = 1500, damage = 0.605},
	}
}
...
-- Movespeed
SWEP.MoveSpeed                   = 0.965                      -- Multiply the player's movespeed by this.
...
SWEP.Attachments = {
	...
	[2] = { atts = { "ins2_ub_laser", "ins2_laser_anpeq15_black", "ins2_laser_anpeq15_tan", "ins2_ub_flashlight", "ins2_eft_lastac2" }},
	[3] = { atts = { "ins2_br_heavy", "r6s_h_barrel", "bo2_longbarrel", }},
	...
	[8] = { atts = { "warface_mcmillan_cs5_fortune_skin", "warface_mcmillan_cs5_gold_skin" }},
}
