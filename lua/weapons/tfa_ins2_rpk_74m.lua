...
SWEP.Category               = ( TFA and TFA.Yankys_Custom_Weapon_Pack_Categories ) and "[TFA] [AT] [ HMGs ]" or "TFA Insurgency"   
SWEP.PrintName				= ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and "Izhmash RPK-74M" or "RPK-74M"   		           
SWEP.Manufacturer 			= "Izhmash"                    -- Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Purpose				= "A upgraded version of the classic RPK-74." 
SWEP.Instructions			= ""              
...
SWEP.Type                   = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and "Type: Light Machine Gun - Caliber: 5.45x39mm - Muzzle Velocity: 950 m/s" or "Machine Gun"
...
SWEP.Primary.SoundEchoTable = {
	[0]   = Sound("TFA_MWR_BERED.TailInside"), 
	[256] = Sound("TFA_MWR_BERED.TailOutside") 
}

SWEP.Primary.Damage                = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and 54 * TFA.Yankys_Custom_Weapon_Pack.DamageMultiplier or 40
...
SWEP.Primary.DefaultClip           = SWEP.Primary.ClipSize * 7 -- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.MuzzleFlashEffect          = ( TFA and TFA.YanKys_Realistic_Muzzleflashes ) and "tfa_muzzleflash_ak74" or "tfa_muzzleflash_rifle"           
...
SWEP.VMPos          = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and Vector(-0.65, 0, -0.4) or Vector(-0.25, 0, -0.42)
...
SWEP.IronSightsPos_2XRDS  = Vector(-3.03, -0.5, -1.54)
...
SWEP.Attachments = {
	...
	[3] = { atts = { "ins2_br_heavy", "r6s_h_barrel", "bo2_longbarrel", "rpk74m_assault_barrel" } },	
...
SWEP.ViewModelBoneMods = {
	...
	["A_Suppressor"] = { scale = Vector(0.8, 0.8, 0.8), pos = Vector(0.1, -1.5, 0), angle = Angle(0, 0, 0) }, 
	["ValveBiped.Bip01_L_Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-6, -2.5, 2) },
}

SWEP.WorldModelBoneMods = {
	["ATTACH_Muzzle"] = { scale = Vector(0.8, 0.8, 0.8), pos = Vector(2, 0, 0), angle = Angle(0, 0, 90) },
