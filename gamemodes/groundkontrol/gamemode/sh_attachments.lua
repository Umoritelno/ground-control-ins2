...
GM.attachmentPrices = {bg_ak74_rpkbarrel = 2500,
	...
	md_insight_x2 = 1500,
	md_rmr = 1000,
	am_ultramegamatchammo = math.huge, -- not buyable
	am_reducedpowderload = false, -- free, since it's basically weaker bullets
	md_cmag_556_official = 1500,
	bg_mp7_unsuppressed = false -- free, since when does removing a suppressor cost money?
}
