...
function GM:getAutoDownloadMapID(mapName)
	return self.AutoDownloadMap[mapName] or "NONE"
end
...
GM:registerAutoDownloadMap("cs_drugbust", "510837069")
GM:registerAutoDownloadMap("cs_office-unlimited", "544864751")
GM:registerAutoDownloadMap("cs_christbust", "2899138208")
GM:registerAutoDownloadMap("cs_christalley", "2905163714")
GM:registerAutoDownloadMap("de_christshanty", "2906661568")
--GM:registerAutoDownloadMap("cs_siege_pcs", "2496373735")
