...
conditioned.convar = "gc_trait2"
conditioned.startLevel = 1
conditioned.maxLevel = 5
conditioned.basePrice = 750
conditioned.pricePerLevel = 250
conditioned.staminaDrainPerLevel = 0.075
conditioned.description = {
	{t = "You've undergone extensive physical preparation to become more endurant.", c = GM.HUDColors.white},
	{t = "Decreases stamina drain from sprinting and jumping by %s per each level.", c = GM.HUDColors.green, formatFunc = function(textToFormat) return string.format(textToFormat, conditioned.staminaDrainPerLevel * 100 .. "%") end},
	{
...
function conditioned:onSpawn(player, currentLevel)
	...
	player.staminaJumpMultiplier = 1 - currentLevel * self.staminaDrainPerLevel
end

function conditioned:remove(player, currentLevel)	
	player.staminaDrainMultiplier = 1
	player.staminaJumpMultiplier = 1
end
...
medic.healthRestorePerLevelMates = 1
medic.description = {
	{t = "You've undergone extensive medical training to treat wounds efficiently.", c = GM.HUDColors.white},
	{t = "Each level increases healing proficiency with the Medkit.", c = GM.HUDColors.green},
...
willToLive.convar = "gc_trait2"
willToLive.startLevel = 1
willToLive.maxLevel = 5
willToLive.basePrice = 1500
willToLive.pricePerLevel = 1500
willToLive.healthRestorePerLevel = 3
willToLive.healthRestoreDelay = 4 -- time in seconds between each HP regen tick
willToLive.healthRestoreDelayOnDamage = 8 -- delay to apply after taking damage
